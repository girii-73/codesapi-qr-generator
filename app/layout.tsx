    ...
    >
      <body className="min-h-full flex flex-col bg-bg-dark text-text-primary">
        ...
        <footer className="border-t border-border py-6">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center text-xs text-text-muted">
            Built for the{" "}
            <span className="text-accent">CodeSapiens</span>{" "}
